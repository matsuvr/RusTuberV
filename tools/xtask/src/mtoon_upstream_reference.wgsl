// The fixed upstream `bevy_vrm1` MToon fragment shader, copied verbatim from
// not-elm/bevy_vrm1 revision f9593fd78136fb9e0507bcae111e09291ec9b82a (0.9.1).
//
// This file is the GPU fixture's independent original reference. It is
// deliberately NOT the production `mtoon::native` module: comparing the
// production Native display against this copy proves the production baseline
// still is the upstream revision, not merely that the Rich composition matches
// whatever the production baseline currently does.
//
// Do not edit the expressions below. If the production baseline must change,
// this reference and the reason have to be recorded together.
